...
type RosterRecommendationSummaryProps = {
  summary: string;
};

export function RosterRecommendationSummary({
  summary
}: RosterRecommendationSummaryProps) {
  return (
    <Card className="p-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <StatusBadge>Roster Summary</StatusBadge>
